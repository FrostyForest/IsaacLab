...
from isaaclab_tasks.manager_based.manipulation.my_lift import mdp
from isaaclab_tasks.manager_based.manipulation.my_lift.lift_env_cfg import LiftEnvCfg
...
class FrankaCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.yellow_object=RigidObjectCfg(
            ...
            init_state=RigidObjectCfg.InitialStateCfg(pos=[0.55, -0.2, 0.055], rot=[1, 0, 0, 0]),
            spawn=UsdFileCfg(
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            ...
            debug_vis=False,
            #visualizer_cfg=marker_cfg,#不需要时隐藏标记
            target_frames=[
