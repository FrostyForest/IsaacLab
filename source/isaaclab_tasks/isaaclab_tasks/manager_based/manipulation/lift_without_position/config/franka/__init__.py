...
gym.register(
    id="Isaac-my_Lift-Cube-Franka-v1",
    entry_point="isaaclab_tasks.manager_based.manipulation.lift_without_position.lift_env:LiftEnv",
    kwargs={
...
gym.register(
    id="Isaac-my_Lift-Cube-Franka-IK-Rel-v1",
    entry_point="isaaclab_tasks.manager_based.manipulation.lift_without_position.lift_env:LiftEnv",
    kwargs={
