...
class CartpoleSceneCfg(InteractiveSceneCfg):
    ...
    room = AssetBaseCfg(prim_path="/World/room", spawn=sim_utils.UsdFileCfg(usd_path=f"{ISAAC_NUCLEUS_DIR}/Environments/Simple_Room/simple_room.usd"))
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        velocity = torch.randn_like(robot.data.joint_pos) * 3.0
